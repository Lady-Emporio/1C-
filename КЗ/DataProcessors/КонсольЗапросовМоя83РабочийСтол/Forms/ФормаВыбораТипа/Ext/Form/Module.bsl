...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭтоРегистрыИОбъекты = Неопределено;
	Параметры.Свойство("ЭтоРегистрыИОбъекты", ЭтоРегистрыИОбъекты);
	ЭтоРегистрыИОбъекты = ?(ЭтоРегистрыИОбъекты = Неопределено, Ложь, ЭтоРегистрыИОбъекты);
	...
	СписокОбъектов.Добавить(Новый Структура("МетаданныеМенеджер,ИмяТаблицы,ИмяМенеджера,Префикс", Неопределено, "БизнесПроцесс", "БизнесПроцессы","БизнесПроцессСсылка"));
	СписокОбъектов.Добавить(Новый Структура("МетаданныеМенеджер,ИмяТаблицы,ИмяМенеджера,Префикс", Неопределено, "Задача", "Задачи","ЗадачаСсылка"));

	Если (Параметры.Свойство("Регистры") И Параметры.Регистры = Истина) ИЛИ ЭтоРегистрыИОбъекты тогда
		
		Если НЕ ЭтоРегистрыИОбъекты тогда
			СписокОбъектов = Новый Массив;         
		КонецЕсли;
