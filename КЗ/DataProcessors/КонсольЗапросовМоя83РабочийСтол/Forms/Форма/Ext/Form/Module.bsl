...
Процедура ПриСозданииНаСервере_ПослеОткрытия()
	...
	ЭтаФорма.КоманднаяПанель.ПодчиненныеЭлементы.ФормаКнопкаВыбораБазы.Заголовок = СтрокаСоединенияИнформационнойБазы();
КонецПроцедуры
...
&НаСервере
Процедура КнопкаВыбораБазыНаСервере()
